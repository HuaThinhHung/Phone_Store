  ...
  for (let i = 0; i < data.length; i++) {
    ...
    contentHTML += `
        <tr>
            ...
            <td>
                <button class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded" onclick="onDeleteProduct(${
                  product.id
                })">Delete</button>
            </td>

            <td>
            <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"data-toggle="modal"data-target="#myModal"onclick="onEditProduct(${
              product.id
            })">Edit</button>
            </td>
            </tr>
